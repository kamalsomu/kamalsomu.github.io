...
/* harmony import */ var _custom_auth_module_custom_auth_module_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./custom-auth-module/custom-auth-module.component */ "./src/app/custom-auth-module/custom-auth-module.component.ts");
...
var routes = [
    ...
    {
        path: "oauth/success/callback",
        component: _custom_auth_module_custom_auth_module_component__WEBPACK_IMPORTED_MODULE_3__["CustomAuthModuleComponent"]
    }
];
...
/* harmony import */ var _custom_auth_module_custom_auth_module_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./custom-auth-module/custom-auth-module.component */ "./src/app/custom-auth-module/custom-auth-module.component.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], _custom_auth_module_custom_auth_module_component__WEBPACK_IMPORTED_MODULE_11__["CustomAuthModuleComponent"]],
            entryComponents: [],
...
/***/ "./src/app/custom-auth-module/custom-auth-module.component.html":
/*!**********************************************************************!*\
  !*** ./src/app/custom-auth-module/custom-auth-module.component.html ***!
  \**********************************************************************/
/*! no static exports found */
...
module.exports = "<p>\n  custom-auth-module works!\n</p>\n"

/***/ }),

/***/ "./src/app/custom-auth-module/custom-auth-module.component.scss":
/*!**********************************************************************!*\
  !*** ./src/app/custom-auth-module/custom-auth-module.component.scss ***!
  \**********************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2N1c3RvbS1hdXRoLW1vZHVsZS9jdXN0b20tYXV0aC1tb2R1bGUuY29tcG9uZW50LnNjc3MifQ== */"

/***/ }),

/***/ "./src/app/custom-auth-module/custom-auth-module.component.ts":
/*!********************************************************************!*\
  !*** ./src/app/custom-auth-module/custom-auth-module.component.ts ***!
  \********************************************************************/
/*! exports provided: CustomAuthModuleComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CustomAuthModuleComponent", function() { return CustomAuthModuleComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var CustomAuthModuleComponent = /** @class */ (function () {
    function CustomAuthModuleComponent(http) {
        var _this = this;
        this.http = http;
        var ACCESS_TOKEN_URL = "http://localhost:5000/auth/oauth/accesstoken?code=";
        var code = this.getURLParam("code");
        if (code != "") {
            this.http.post(ACCESS_TOKEN_URL + code, "").subscribe(function (response) {
                console.log(response);
                alert("response==" + JSON.stringify(response));
                //let resJSON = JSON.parse(response);
                var reqBody = {
                    "accessToken": response.results.accessToken,
                    "instanceURL": response.results.instanceURL
                };
                var options = {
                    "headers": {
                ...
                _this.http.post("http://localhost:5000/api/users", JSON.stringify(reqBody), options).subscribe(function (response) {
                    console.log(response);
                    alert("response users...==" + JSON.stringify(response));
                });
            });
        }
        /*
            if(this.getURLParam("code")!="")
          {
            ...
            let params = {
              ...
              "client_id": "3MVG9d8..z.hDcPI3Wo20qCaLCGHp_fL_KuzDpKqdgUUFH3R4yGArt3tYOcxgJPsCYiwA1t20S2Oxk0Vm82ZD",
              "client_secret": "170224CF39671B40419BDB3D70E5548767E251AECD18F68604A791A42D8A320A",
             "code":code,
             "redirect_uri":"http://localhost:8100/oauth/success/callback"
            }
        ...
        var clientId="3MVG9d8..z.hDcPI3Wo20qCaLCGHp_fL_KuzDpKqdgUUFH3R4yGArt3tYOcxgJPsCYiwA1t20S2Oxk0Vm82ZD";
        var clientSecret="170224CF39671B40419BDB3D70E5548767E251AECD18F68604A791A42D8A320A";
        ...
        this.http.post("https://kamalsomu-dev-ed.my.salesforce.com/services/oauth2/token",JSON.stringify(params)).subscribe((response) => {
          console.log(response);
          alert("response=="+response);
        });
        
        /*
        this.http.post("https://login.salesforce.com/services/oauth2/token",JSON.stringify(params)).subscribe((response) => {
          console.log(response);
          alert("response=="+response);
        });
    ...
    CustomAuthModuleComponent.prototype.getURLParam = function (name) {
        if (name = (new RegExp('[?&]' + encodeURIComponent(name) + '=([^&]*)')).exec(location.search))
            return decodeURIComponent(name[1]);
    };
    CustomAuthModuleComponent.prototype.ngOnInit = function () { };
    CustomAuthModuleComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-custom-auth-module',
            template: __webpack_require__(/*! ./custom-auth-module.component.html */ "./src/app/custom-auth-module/custom-auth-module.component.html"),
            styles: [__webpack_require__(/*! ./custom-auth-module.component.scss */ "./src/app/custom-auth-module/custom-auth-module.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])
    ], CustomAuthModuleComponent);
    return CustomAuthModuleComponent;
}());
...
module.exports = __webpack_require__(/*! /Users/kamala/Documents/ionic app examples/oauthcustomsfionicapp/sfapp/src/main.ts */"./src/main.ts");
